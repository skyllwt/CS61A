...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        chile_frame = Frame(self)

        current_formal_list = formals
        current_val_list = vals

        while current_formal_list is not nil:
            symbol = current_formal_list.first
            value = current_val_list.first
            chile_frame.define(symbol, value)
            current_formal_list = current_formal_list.rest
            current_val_list = current_val_list.rest
